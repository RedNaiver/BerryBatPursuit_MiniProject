...
public class CameraManager : MonoBehaviour
{
    ...
    public LayerMask collisionLayers; // Things your camera will collide with in the environment / the layers
    ...
    // Takes the camera and push it forward/backward depending on collision
